...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="w-100 text-end mb-3">
                            <a href="{{ route('admin.company-history.create') }}" class="btn btn-outline-primary px-2 py-1 w-sm-100">
                                <i class="bi bi-plus-lg"></i> New
                            </a>
                        </div>

                        <table class="table table-striped table-hover" id="tableCompanyHistory">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Year</th>
                                                ...
                                                <ul class="dropdown-menu shadow border-0 p-2">
                                                    <li>
                                                        <a class="dropdown-item" 
                                                            href="{{ route('admin.company-history.edit', ['id' => $dt->id]) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <!-- ----- FORM DELETE ----- -->
                                                        <form action="{{ route('admin.company-history.delete', ['id' => $dt->id]) }}" 
    ...
    <script>
        $(document).ready(function() {
            // ----- DATATABLES -----
            let tableCompanyHistory = $('#tableCompanyHistory')
                .css({ "min-width": "99%" })
                .removeAttr("width")
                .DataTable({
                    sorting: [],
