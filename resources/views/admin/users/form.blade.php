...
@section('content')
    ...
    <?php
        ...
        if (!isset($form_todo) || $form_todo == 'CREATE')
        {
            ...
            $form_button = "
            <button type='button'
                target-module='". route('admin.users.view', ['id' => $id]) ."'
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-9">
                        ...
                        <ol class="breadcrumb bg-transparent mb-0">
                            ...
                            <li class="breadcrumb-item"><a class="btnCancel" href="#" target-module="{{ route('admin.users') }}">Users</a></li>
                    ...
                    <div class="col-3 text-end">
                        ...
                        @endphp
                        @if ($form_todo == 'UPDATE' || is_super_admin())
                            <button type="button"
                            ...
                            <div class="card">
                                <div class="card-body py-3">
                                    ...
                                    @if ($form_todo == 'UPDATE')
                                        ...
                                        <div class="form-group row my-2">
                                            <label for="email" class="col-sm-2 col-form-label">
                                                Confirm Password <?= $form_required ?>
                                            </label>
                                            <div class="col-sm-10">
                                                <div class="input-group has-validation">
                                                    <input type="password"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btnPreviewPassword', function(e) {
                e.preventDefault();
                $parent = $(this).parent().parent('.input-group');
                ...
                $parent.find(`input.password`).attr('type', isPreview == 'true' ? 'text' : 'password');
