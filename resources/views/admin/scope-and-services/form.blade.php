...
@section('content')
    ...
    <?php
        ...
        if (!isset($form_todo) || $form_todo == 'CREATE')
        {
            ...
            $form_action = route('admin.scope-and-services.save');
            $form_method = 'POST';
            $form_required = "<code>*</code>";
            $form_button = "
            <button type='button'
                target-module='". route('admin.scope-and-services') ."'
        ...
        else if ($form_todo == 'READ')
        {
            ...
            <div class='d-flex justify-content-end'>
                ...
                <a href=". route('admin.scope-and-services.edit', ['id' => $id]) ."
        ...
        else if ($form_todo == 'UPDATE')
        {
            ...
            $prevent_refresh = 'true';
            $form_action = route('admin.scope-and-services.update', ['id' => $id]);
            $form_method = 'PUT';
            $form_required = "<code>*</code>";
            $form_button = "
            <button type='button'
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-9">
                        ...
                        <ol class="breadcrumb bg-transparent mb-0">
                            ...
                            <li class="breadcrumb-item"><a class="btnCancel" href="#" target-module="{{ route('admin.scope-and-services') }}">Scope and Services</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        @if ($form_todo != 'CREATE')
                            <!-- ----- FORM DELETE ----- -->
                            <form action='{{ route('admin.scope-and-services.delete', ['id' => $id]) }}' method='POST' id='formDelete'>
                                @csrf
                                @method('DELETE')
                            </form>
                            <!-- ----- END FORM DELETE ----- -->
    ...
    <script>
        $(document).ready(function() {
            ...
            // ----- SUBMIT FORM -----
            $(document).on('submit', '#formScopeAndServices', function(e) {
                    ...
                    let confirmation = $.confirm({
                        ...
                        buttons: {
                            ...
                            yes: {
                                ...
                                action: function() {
                                    preventRefresh(false);
                                    $('#formScopeAndServices').attr('validated', 'true').submit();
